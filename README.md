...
| 4 | [Client-side encryption, Django, PostgreSQL](https://github.com/cossacklabs/acra-engineering-demo/#example-4-client-side-encryption-django-postgresql)                                         | Django web application with client-side encryption (AcraWriter), decryption on AcraServer, PostgreSQL                         |
| 5 | [Client-side encryption, Ruby on Rails app, PostgreSQL](https://github.com/cossacklabs/acra-engineering-demo/#example-5-client-side-encryption-ruby-on-rails-app-postgresql)                   | Ruby on Rails web application, client-side encryption, decryption on AcraServer, PostgreSQL                                   |
| 6 | [SQL injection prevention, AcraCensor](https://github.com/cossacklabs/acra-engineering-demo/#example-6-sql-injection-prevention-acracensor)                                                    | OWASP Mutillidae vulnerable web application, AcraConnector, AcraServer, AcraCensor (SQL firewall)                             |
| 7 | [Load balancing](https://github.com/cossacklabs/acra-engineering-demo/#example-7-load-balancing)                                                                                               | python client application, AcraServer, HAProxy                                                                                |
| 8 | [Search in encrypted data](https://github.com/cossacklabs/acra-engineering-demo/#example-8-search-in-encrypted-data)                                                                           | python client app, AcraServer, MySQL / PostreSQL database                                                                     |
| 9 | [AcraTranslator Demo](https://github.com/cossacklabs/acra-engineering-demo/#example-9-acratranslator-usage)                                                                                    | Go API Server, AcraTranslator, MongoDB                                                                                        |
